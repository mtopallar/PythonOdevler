...
class TestTestcountOfProduct():
  ...
  def test_testcountOfProduct(self):
    ...
    self.vars["countOfProduct"] = len(self.driver.find_elements(By.XPATH, "//div[@class=\"inventory_item\"]"))
    assert(self.vars["countOfProduct"] == 6)
